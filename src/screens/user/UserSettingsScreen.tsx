    ...
    <>
      <UserLayout>
        ...
        >
          ...
          <View
            style={tw`flex items-center sm:flex-row sm:items-start bg-white dark:bg-gray-900 w-full`}
          >
            <View
              style={tw`flex flex-col sm:flex-row items-center sm:items-start max-w-md sm:gap-8 px-4 w-full`}
            >
